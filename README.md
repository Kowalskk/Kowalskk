...
|---------|-------------|--------|
| **[ProphetLabs](https://github.com/Kowalskk/prophetlabs)** | Prediction market arbitrage engine. Polymarket ↔ Opinion Labs, WebSocket streaming, 3-pass matching with LLM validation | ✅ Live |
...
- **I build what I need.** Every project started because I was the user and the tool didn't exist.
- **Speed > perfection.** AI-assisted dev means concept → deployed MVP in days. I iterate from there.
- **Business brain + crypto hands.** 13 years of P&L management means I think about unit economics, not just code.
- **Grinding is a skill.** WoW endgame guilds, airdrop farming, factory operations — same muscle, different arena.
